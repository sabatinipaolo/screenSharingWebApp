...
socket.on('lista partecipanti', function(p) {
  console.log('lista partecipanti: ' + p);
  partecipanti.innerHTML+=p;
});
...
var schermoCondiviso = document.querySelector('#schermoCondiviso');
//var remoteVideo = document.querySelector('#remoteVideo');
